...
@Slf4j
@Controller
@RequestMapping("/admin/rainDataMeasure")
public class RainDataMeasureController extends JqGridAbstract<OtherDataMeasureDto> {
    ...
    protected List getList(Map param) {
    	...
    	return rainDataMeasureService.getList(param);
    }
    ...
    protected int getTotalCount(Map param) {
        ...
        return rainDataMeasureService.getTotalCount(param);
    }

    @Override
    protected String setViewPage() {
        return "admin/rainDataMeasure";
    }
