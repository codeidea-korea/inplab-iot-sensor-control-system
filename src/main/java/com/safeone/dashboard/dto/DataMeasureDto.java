...
@Data
public class DataMeasureDto implements Serializable {
//	@FieldLabel(title="실 운용 센서값")
//	String real_value;		//실제 운용되는 센서값(센서변환값 - 센서 초기값)
	@FieldLabel(title="수집 일시", width=150, type = "timestamp_range")
	String collect_date;
...
//	0.0;		2023/08/04/17:22:15;	0.0;		00000;		255;		0139;	testbed003;	4;		2023-08-04T17:21:42.517
	...
	@FieldLabel(title="x_raw_data")
	String x_raw_data;
	@FieldLabel(title="x_deg")
	String x_deg;
	@FieldLabel(title="y_raw_data")
	String y_raw_data;
	@FieldLabel(title="y_deg")
	String y_deg;
