...
<html lang="ko">
    ...
    <head>
        ...
        <style>
            ...
            .status-container>.title:before{content: ""; width: 11.6rem; height: 3px; background-color: #6685ff; display: inline-block; position:absolute; left: 0; bottom:-2px;}
    ...
    <script>
        ...
        function initSiteZone() {
            ...
            $.each(_assetKind, function(idx) {
                let html = '<li kind="' + this.code + '"><div class="site-zone-title"><strong>' + this.name + '</strong><p class="check-box" notxt="" small="">';
            ...
            $.get('/getMarkerList', { zone_id : zone_id }, function(res) {
                $.each(res, function(idx) {
                    ...
                    let uid = window.vworld.addOverlay(
                        ...
                        + '</span></div>', coords,
                        '/images/' + img, this.asset_name, null, { type : type, asset_id : this.asset_id, zone_id : this.zone_id, etc1 : this.etc1});
                        ...
                        if (this.asset_id === alarm.asset_id) {
                            ...
                            if (alarm.risk_level !== undefined) {
                                ...
                                if (alarmRiskLevel > currentRiskLevel) {
                                    zoneArea['area_' + alarm.zone_id] = { zone_id: alarm.zone_id, risk_level: alarm.risk_level };
                                }
                            } else {
        ...
        <section
            ...
            <div id="lay-weather-area" class="layer-base">
                ...
                <div
                    ...
                    <iframe src="https://www.weather.go.kr/w/weather/forecast/short-term.do?nolayout=Y#dong/4375035000" width="100%" height="100%" frameborder="0" style="padding: 10px">
                    </iframe>
                </div>
            </div>
            <!--[e] 오늘의 날씨 팝업 -->
            ...
            <div id="lay-weather-area2" class="layer-base">
                ...
                <div class="layer-base-conts" style="height: 700px;">
                    <iframe src="https://www.weather.go.kr/w/weather/warning/status.do?nolayout=Y#dong/4375035000" width="100%" height="100%" frameborder="0" style="padding: 10px">
                    </iframe>
                </div>
            </div>
            <!--[e] 기상특보 팝업 -->
            ...
            <div id="lay-cctv-view" class="layer-base">
                <div class="layer-base-btns">
                    <a href="javascript:void(0);" class="fullscreen"><img src="/images/btn_lay_full.png" data-fancybox-full alt="전체화면"/></a>
                    <a href="javascript:void(0);" class="closeCctv"><img src="/images/btn_lay_close.png" data-fancybox-close alt="닫기"/></a>
                </div>
