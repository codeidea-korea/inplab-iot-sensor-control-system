        ...
        $(function () {
            ...
            function getChartData(sens_no, startDateTime, endDateTime, sensChnlId, selectType) {
                return new Promise((resolve) => {
                    $.ajax({
                        /*url: '/sensor-grouping/chart' + '?sens_no=' + sens_no + '&start_date_time=' + startDateTime + '&end_date_time=' + endDateTime + "&sens_chnl_id=" + sensChnlId + "&selectType=" + selectType + "&init_base=raw&measure_base=raw&minute_bucket=raw",*/
            ...
            async function updateChart(data) {
                ...
                const seriesColors = data.map((item) => {
                    ...
                    sensorColorTracker[sensNo]++; // 다음 채널을 위해 증가
