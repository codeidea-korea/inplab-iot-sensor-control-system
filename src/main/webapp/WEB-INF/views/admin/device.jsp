                    ...
                    if (targetArr.length > 0) {
                        confirm(targetArr.length + '건의 데이터를 삭제하시겠습니까?', function () {
                            $.each(targetArr, function (idx) {
                                $.get('/admin/device/del', this, function (res) { // todo : 1이 아닌 경우 삭제가 실패된것을 알릴것인지?
...
//                             reloadJqGrid();
                ...
                $('.insertBtn').on('click', function () {
                    ...
                    $('#lay-form-write input[type=submit]').off().on('click', function () {
                        ...
                        $.get('/admin/device/add', getSerialize('#lay-form-write'), function (res) {
                ...
                $('.modifyBtn').on('click', function () {
                    ...
                    $('#lay-form-write input[type=submit]').off().on('click', function () {
                        ...
                        $.get('/admin/device/mod', getSerialize('#lay-form-write'), function (res) {
                            alert('저장되었습니다.', function () {
                                popFancyClose('#lay-form-write');
                            });
                            reloadJqGrid();
            ...
            function validate() {
                if ($('#lay-form-write input[name=device_id]').val().trim() == '') {
                    $('#lay-form-write input[name=device_id]').focus();
                    alert('로거 ID를 입력해주세요.');
                    return false;
                }
